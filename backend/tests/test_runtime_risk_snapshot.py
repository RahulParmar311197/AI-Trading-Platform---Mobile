...
def provider(tmp_path, positions=None, account=None, loss=10.0):
    ...
    return RuntimeRiskSnapshotProvider(router, lifecycle, trading_day_timezone="Asia/Kolkata", projected_trade_loss_provider=lambda req: loss)
