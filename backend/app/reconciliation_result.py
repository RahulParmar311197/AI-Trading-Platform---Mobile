...
class ReconciliationResult:
    """Immutable broker reconciliation result bound to one broker snapshot."""
    ...
    @classmethod
    def from_verified_state(cls, *, account_id: str, generation: int, reconciled_at: datetime, open_orders_reconciled: bool, positions_reconciled: bool, submission_intents_resolved: int, broker_ready: bool, broker_snapshot_fingerprint: str) -> "ReconciliationResult":
