...
def execute_paper(*, risk: RiskGatewayResult, broker: PaperBroker | None = None, account_id: str = 'paper', broker_name: str = 'paper', request_id: str | None = None, idempotency_store: IdempotencyStore | None = None, connectivity: BrokerConnectivitySupervisor | None = None) -> ExecutionResult:
...
__all__ = ['OrderStatus', 'ExecutionResult', 'ExecutionAdapter', 'PaperBroker', 'execute_paper']
