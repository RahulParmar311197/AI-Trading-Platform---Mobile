...
def create_app(resources: AppResources | None = None, broker_router: BrokerRouter | None = None, execution_health_token: str | None = None) -> FastAPI:
    ...
    app.state.broker_router = broker_router or build_broker_router(resources.safety_store, context_attestor=resources.broker_context_attestor, submission_intent_store=resources.submission_intent_store, risk_reservation_store=resources.risk_reservation_store)
