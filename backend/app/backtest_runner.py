...
class BacktestRunRequest:
 symbol:str; timeframe:str; start:object; end:object; initial_equity:float; risk_pct:float=1.0; exchange:str='NSE'
@dataclass(frozen=True)
...
class BacktestRunner:
 ...
 def run(self,req:BacktestRunRequest)->BacktestRunResult:
  candles=self.loader.load(HistoricalDataRequest(req.symbol,req.timeframe,req.start,req.end,exchange=req.exchange)); portfolio=PaperPortfolio(req.initial_equity); equity=[req.initial_equity]
